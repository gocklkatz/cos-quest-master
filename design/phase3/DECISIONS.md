...
Each entry records a significant fork in the road: what was decided, why, and what was rejected. Ordered chronologically. IDs are stable and never reused.

---

### D-P3-01 · 2026-03-11: P3-F2 — Follow-up question placed in ReviewModal, not QuestPanel
...
**Affects**: [feature-02-ai-elaborative-interrogation.md](feature-02-ai-elaborative-interrogation.md)

---

### D-P3-02 · 2026-03-11: P3-C4 — AI-disabled banner Settings link uses Output event
...
**Affects**: [change-04-migrate-app-to-quest-view.md](change-04-migrate-app-to-quest-view.md)

---

### D-P3-03 · 2026-03-11: P3-C4 — Standalone component test isolation with overrideComponent
...
### D-P3-04 · 2026-03-11: P3-F9 — Loading indicator scope and retry strategy
...
**Affects**: [feature-09-quest-generation-indicator.md](feature-09-quest-generation-indicator.md)

---

### D-P3-05 · 2026-03-11: P3-F4 — D3.js chosen over pure SVG for tree layout
...
**Affects**: [feature-04-global-tree-visualizer.md](feature-04-global-tree-visualizer.md)

---

### D-P3-06 · 2026-03-11: P3-F4 — Globals inclusion filter uses allow-list regex, not deny-list
...
### D-P3-07 · 2026-03-11: P3-F4 — Node-count cap: 50 children per node, 200 nodes total
...
### D-P3-08 · 2026-03-11: P3-F4 — UI placement is full-page /tree route (not sidebar tab)
...
### D-P3-09 · 2026-03-11: P3-F4 — GlobalService delegates to IrisApiService, not direct HttpClient
...
### D-P3-10 · 2026-03-11: P3-F5 — GuildMember class defined by player (Option A), class name prescribed
...
**Affects**: [feature-05-unified-spiral-quests.md](feature-05-unified-spiral-quests.md)

---

### D-P3-11 · 2026-03-11: P3-F5 — capstone-02 uses SQL SELECT, not %OpenId, to avoid ID threading
...
### D-P3-12 · 2026-03-11: P3-F8 — Active time definition: Page Visibility + 120 s idle timeout
...
**Affects**: [feature-08-quest-time-tracking-goals.md](feature-08-quest-time-tracking-goals.md)

---

### D-P3-13 · 2026-03-11: P3-F8 — Weekly goals deferred; daily only in scope
...
### D-P3-14 · 2026-03-11: P3-F8 — New achievements are time-based, not completion-based
...
### D-P3-15 · 2026-03-11: P3-F8 — Goal Met indicator is ambient progress bar, not toast
...
**Affects**: [feature-06-code-prediction-quests.md](feature-06-code-prediction-quests.md)

---

### D-P3-17 · 2026-03-11: P3-F6 — Completion flow: synthesise EvaluationResult, reuse ReviewModal
...
### D-P3-18 · 2026-03-11: P3-F6 — Wrong answer: no retry, treat as learning moment
...
### D-P3-19 · 2026-03-12: P3-F13 — skipQuest() reads apiKey from GameStateService, not a parameter
...
**Affects**: [feature-13-skip-quest.md](feature-13-skip-quest.md)

---

### D-P3-20 · 2026-03-12: P3-F13 — skipsThisSession is in-memory only, not persisted to localStorage
...
### D-P3-21 · 2026-03-11: P3-F6 — Read-only mechanism: questType check, not QuestFile.readOnly
...
### D-P3-22 · 2026-03-16: P3-F10 — Modal for failed quests and no "Try Again" button
...
**Affects**: [feature-10-review-modal.md](feature-10-review-modal.md)

---

### D-P3-23 · 2026-03-11: P3-F4 — Test coverage: Vitest unit test for GlobalService only
